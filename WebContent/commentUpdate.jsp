		...
		<div class="col-lg-10">
			<div class="jumbotron" style="padding-top: 1px;">				
				...
				<form name = c_commentUpdate>
					<textarea id="update" style="width:400px;height:50px;" maxlength=1024 value="<%= commentText %>"></textarea><br>
					<input type="button" class="btn btn-primary" onclick="send(<%=boardID %>,<%=bbsID %>,<%=commentID %>)" value="수정">
					<br><br>
				</form>
			</div>
		</div>
